      ...
      <div className="card p-6 sm:p-8">
        ...
        <div className="relative my-6">
          ...
          <div className="relative flex justify-center text-sm">
            <span className="px-2 bg-white text-navy-400">o continúa con</span>
          </div>
        </div>
        ...
        <button
          ...
          disabled={loading}
          className="w-full flex items-center justify-center gap-3 px-4 py-3 border border-navy-200 rounded-lg hover:bg-navy-50 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
        >
          ...
          <span className="font-medium text-navy-700">Google</span>
        </button>
